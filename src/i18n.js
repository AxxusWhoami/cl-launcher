...
const TRANSLATIONS = {
  esES: {
    ...
    "pkgmgr.hd-armor.name":      "Equipación",
    "pkgmgr.hd-armor.desc":      "Armaduras, armas y escudos",
  ...
  enUS: {
    ...
    "pkgmgr.hd-armor.name":      "Equipment",
    "pkgmgr.hd-armor.desc":      "Armor, weapons and shields",
  ...
  frFR: {
    ...
    "pkgmgr.hd-armor.name":      "Équipement",
    "pkgmgr.hd-armor.desc":      "Armures, armes et boucliers",
  ...
  deDE: {
    ...
    "pkgmgr.hd-armor.name":      "Ausrüstung",
    "pkgmgr.hd-armor.desc":      "Rüstungen, Waffen und Schilde",

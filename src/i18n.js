...
const TRANSLATIONS = {
  esES: {
    ...
    "pkgmgr.hd-armor.name":      "Texturas de equipo en HD",
    ...
    "pkgmgr.hd-creatures.desc.1":"Nuevos modelos de criaturas",
    "pkgmgr.hd-creatures.desc.2":"Nuevos modelos de monturas",
    "pkgmgr.hd-trees.name":      "Modelos HD de árboles",
    "pkgmgr.hd-trees.desc":      "Nuevos modelos en HD para los árboles del mundo.",
    "pkgmgr.hd-spells.name":     "Efectos visuales de hechizos",
    "pkgmgr.hd-spells.desc":     "Nueva apariencia visual para diversos hechizos.",
  ...
  enUS: {
    ...
    "pkgmgr.hd-armor.name":      "HD Equipment Textures",
    ...
    "pkgmgr.hd-creatures.desc.1":"New creature models",
    "pkgmgr.hd-creatures.desc.2":"New mount models",
    "pkgmgr.hd-trees.name":      "HD Tree Models",
    "pkgmgr.hd-trees.desc":      "New HD models for trees.",
    "pkgmgr.hd-spells.name":     "Spell Visual Effects",
    "pkgmgr.hd-spells.desc":     "New visual appearance for various spells.",
  ...
  frFR: {
    ...
    "pkgmgr.hd-armor.name":      "Textures d'équipement HD",
    ...
    "pkgmgr.hd-creatures.desc.1":"Nouveaux modèles de créatures",
    "pkgmgr.hd-creatures.desc.2":"Nouveaux modèles de montures",
    "pkgmgr.hd-trees.name":      "Modèles HD d'arbres",
    "pkgmgr.hd-trees.desc":      "Nouveaux modèles HD pour les arbres.",
    "pkgmgr.hd-spells.name":     "Effets visuels de sorts",
    "pkgmgr.hd-spells.desc":     "Nouvelle apparence visuelle pour divers sorts.",
  ...
  deDE: {
    ...
    "pkgmgr.hd-armor.name":      "HD-Ausrüstungstexturen",
    ...
    "pkgmgr.hd-creatures.desc.1":"Neue Kreaturmodelle",
    "pkgmgr.hd-creatures.desc.2":"Neue Reittiermodelle",
    "pkgmgr.hd-trees.name":      "HD-Baummodelle",
    "pkgmgr.hd-trees.desc":      "Neue HD-Modelle für Bäume.",
    "pkgmgr.hd-spells.name":     "Zauber-Visualeffekte",
    "pkgmgr.hd-spells.desc":     "Neues visuelles Erscheinungsbild für verschiedene Zauber.",

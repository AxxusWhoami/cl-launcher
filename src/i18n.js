...
const TRANSLATIONS = {
  esES: {
    ...
    "pkgmgr.hd-trees.desc":      "Nuevos modelos de árboles del mundo.",
  ...
  enUS: {
    ...
    "pkgmgr.hd-trees.desc":      "New models for trees.",
  ...
  frFR: {
    ...
    "pkgmgr.hd-trees.desc":      "Nouveaux modèles d'arbres.",
  ...
  deDE: {
    ...
    "pkgmgr.hd-trees.desc":      "Neue Modelle für Bäume.",
